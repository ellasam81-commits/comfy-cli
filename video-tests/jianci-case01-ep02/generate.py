"""Generate only the approved second episode, with a six-submission hard limit."""
...
def main():
    cfg = config()
    if os.environ.get("JIANCI_EP02_EXECUTE") != "1":
        print("Validated: Episode 02 only, 6 x 10 sec, 12 shots, estimated USD 3. No API calls.")
        return
    ...
    report = {"episode": 2, "model": "wan3.0-video", "estimated_usd": 3, "clips": []}
