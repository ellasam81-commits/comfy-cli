...
def main():
 ...
 out=Path('output/jianci-ep04-repair');out.mkdir(parents=True,exist_ok=True)
 ...
 report={'episode':4,'model':'wan3.0-video','estimate_usd':0.5,'mode':'six new episode4 scenes','clips':[]};s.save_report(out,report);pending=[]
