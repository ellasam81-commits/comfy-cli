...
flt="[0:v]trim=start=0:end=5,setpts=PTS-STARTPTS[a];[0:v]trim=start=5:end=10,setpts=PTS-STARTPTS,crop=500:192:0:92,scale=854:328,pad=854:480:0:74:black[b];[a][b]concat=n=2:v=1:a=0[v]"
